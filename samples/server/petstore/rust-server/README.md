...
- API version: 1.0.0
<<<<<<< HEAD
- Build date: 2018-05-01T11:11:16.685+01:00
=======
- Build date: 2018-04-26T16:54:17.521+01:00
>>>>>>> b9c636e... Generate RequestParser trait to allow retrieiving operation ID in middlewares
...
cargo run --example client PostUrlEncodedForm
cargo run --example client PostXmlFeatures
cargo run --example client PutPlainText
cargo run --example client UuidHeader
