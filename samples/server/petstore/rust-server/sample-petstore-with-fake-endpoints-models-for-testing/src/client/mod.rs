...
if let Some(body) = body {
    ...
    fn test_enum_parameters(&self, param_enum_header_string_array: Option<&Vec<String>>, param_enum_header_string: Option<String>, param_enum_query_string_array: Option<&Vec<String>>, param_enum_query_string: Option<String>, param_enum_query_integer: Option<i32>, param_enum_form_string_array: Option<&Vec<String>>, param_enum_form_string: Option<String>, param_enum_query_double: Option<f64>, context: &C) -> Box<Future<Item=TestEnumParametersResponse, Error=ApiError>> {
    ...
    fn add_pet(&self, param_pet: models::Pet, context: &C) -> Box<Future<Item=AddPetResponse, Error=ApiError>> {
        ...
        let body = serde_json::to_string(&param_pet).expect("impossible to fail to serialize");
